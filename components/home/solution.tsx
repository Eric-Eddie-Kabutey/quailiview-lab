...
const SolutionCard = ({
  ...
  <motion.div
    ...
    className={`rounded-3xl shadow-sm overflow-hidden flex flex-col lg:aspect-square ${cardBgColor}`}
  >
    <div className="flex items-end flex-grow">
      <div className="w-1/2 md:w-3/5 p-8 md:p-12 flex items-center">
        <h3 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-tight">{title}</h3>
      </div>
      <div className={`w-1/2 md:w-2/5 p-8 md:p-10 self-stretch flex items-center justify-center ${visualBgColor}`}>
        {visual}
      </div>
    </div>
    
    <div className="p-8 md:p-12 border-t border-gray-300/50 bg-white/10 backdrop-blur-sm">
  ...
  return (
    <section id='solutions' className="relative bg-white py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto lg:max-w-5xl xl:max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-12 md:mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <SolutionCard
            title="By Capability"
