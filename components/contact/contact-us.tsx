...
function ContactForm({ onSuccess }: { onSuccess: () => void }) {
	...
	return (
		<div className='bg-[#E4E5E9] p-8 rounded-2xl shadow-lg border border-gray-400'>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input placeholder='+1' {...field} className='border border-gray-400' />
								</FormControl>
								<FormMessage className='text-red-500' />
							</FormItem>
						)}
						...
						render={({ field }) => (
							<FormItem>
								...
								<Select
									...
									<SelectContent className='w-full inline-block bg-[#E4E5E9] border border-gray-400'>
...
function SuccessMessage() {
	return (
		<div className='bg-[#E4E5E9] p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col gap-4 md:gap-8 items-center text-center'>            
			...
			<div className='flex flex-col  gap-4 w-full'>
				<Button
					asChild
					className='w-full bg-[#03444A] hover:bg-[#03444A]'>
...
export default function ContactUs() {
	...
	return (
		<section className='relative bg-[#E4E5E9] py-24 sm:py-32'>
			<div className='absolute inset-0 flex justify-around opacity-75 pointer-events-none'>
				{[...Array(6)].map((_, i) => (
					<div
						key={i}
						className='w-px bg-dotted-line-y'
